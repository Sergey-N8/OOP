package OOP.Home_Work.HW_5.views;

import OOP.Home_Work.HW_5.models.Table;
import OOP.Home_Work.HW_5.presenters.View;
import OOP.Home_Work.HW_5.presenters.ViewObserver;
...
public class BookingView implements View {
    ...
    public void changeReservationTable(int oldReservation, Date reservationDate, int tableNo, String name){
        observer.onDelReservationTable(oldReservation, reservationDate, tableNo, name);
    }
